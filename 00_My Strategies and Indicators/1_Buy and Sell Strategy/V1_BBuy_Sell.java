//@version=5
strategy(title="Range Filter Buy and Sell 5min", shorttitle="Range Filter", overlay=true)
...
if(strategy.position_size > 0)
    stopLossPrice = strategy.position_avg_price - stopLossPips * syminfo.mintick
    strategy.exit("Long", "Stop Loss", loss=stopLossPrice)

if(strategy.position_size < 0)
    stopLossPrice = strategy.position_avg_price + stopLossPips * syminfo.mintick
    strategy.exit("Short", "Stop Loss", loss=stopLossPrice)
